...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="${H - 120}" font-family="monospace" font-size="34" font-weight="700" fill="#E9E3D6" letter-spacing="4">LOGICA</text>
  <text x="${W - 64}" y="${H - 120}" font-family="Georgia, serif" font-size="44" fill="#1F2024" text-anchor="end" font-style="italic">Luce</text>
  <text x="${W / 2}" y="${H / 2 - 20}" font-family="Georgia, serif" font-size="72" fill="#C68A3E" text-anchor="middle">Luce e Logica</text>
